<article class="card h-100">
    ...
    <div class="card-body">
        ...
        <span class="card-text text-dark card-article-content" id="editor"><?= mb_substr($article->content, 0, mb_strpos($article->content, ' ', 160)) . '...' ?> <button type="button" class="btn btn-outline-secondary btn-sm border-0">En savoir plus</button></span>
    </div>
